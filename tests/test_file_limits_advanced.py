...
"""
        ...
        self.assertTrue(
            syft_large.has_write_access("owner@example.com"), "Owner should bypass file size limits"
        )

        # Owner should have write access to symlink (despite symlink restriction)
        syft_symlink = syft_perm.open(symlink_file)
        self.assertTrue(
            syft_symlink.has_write_access("owner@example.com"),
        ...
        self.assertTrue(
            syft_dir.has_write_access("owner@example.com"),
            "Owner should bypass directory restrictions",
        )

        # Non-owner alice should be blocked by limits
        self.assertFalse(
            syft_large.has_write_access("alice@example.com"),
            "Non-owner should be blocked by size limit",
        )
        self.assertFalse(
            syft_symlink.has_write_access("alice@example.com"),
            "Non-owner should be blocked by symlink restriction",
        )
        self.assertFalse(
            syft_dir.has_write_access("alice@example.com"),
...
"""
        ...
        self.assertFalse(
            syft_large.has_create_access("alice@example.com"),
...
"""
        ...
        self.assertTrue(
            syft_root.has_write_access("alice@example.com"),
        ...
        self.assertFalse(
            syft_dir1.has_write_access("alice@example.com"),
...
"""
        ...
        self.assertTrue(
            syft_py.has_write_access("alice@example.com"),
        ...
        if "sources" in perms and perms["sources"].get("write"):
            ...
            if write_sources:
                self.assertEqual(
                    write_sources[0]["pattern"], "*.py", "Current impl: Falls back to *.py pattern"
                )
...
"""
        ...
        self.assertTrue(
            syft_parent.has_write_access("alice@example.com"),
        ...
        self.assertFalse(
            syft_child.has_write_access("alice@example.com"),
...
"""
        ...
        self.assertTrue(
            syft_py.has_write_access("alice@example.com"), "Python files should have no size limits"
        )
